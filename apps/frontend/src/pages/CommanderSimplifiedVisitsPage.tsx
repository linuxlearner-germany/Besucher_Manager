...
export function CommanderSimplifiedVisitsPage() {
  ...
  return <AppLayout><main className="page-panel page-shell-wide"><section className="page-hero"><h2>Vereinfachte Erfassungen</h2><p>Nur lesender Zugriff auf Web- und XLSX-Erfassungen.</p></section>
